...
class PopularServiceCardLandscape extends StatefulWidget {
  final serviceList;
  PopularServiceCardLandscape(this.serviceList);
  @override
  _PopularServiceCardLandscapeState createState() => _PopularServiceCardLandscapeState();
}

class _PopularServiceCardLandscapeState extends State<PopularServiceCardLandscape> {
  List<String> images = [];
  var image;
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Text(
                          ...
                          'Name' 
                          : '${widget.serviceList.fname} ${widget.serviceList.lname}',

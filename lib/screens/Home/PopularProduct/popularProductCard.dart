...
import 'package:miss_stitch/screens/Home/PopularProduct/popularProductDetails.dart';
import 'package:miss_stitch/screens/Home/outfit.dart';

class PopularProductCard extends StatefulWidget {
  final productList;
  PopularProductCard(this.productList);
  @override
      ...
      child: GestureDetector(
        ...
        onTap: () {
          ...
          Navigator.push(
              context,
              SlideLeftRoute(
                  page: PopularProductDetails(widget.productList, '2')));
          // Navigator.push(
          //   context,
